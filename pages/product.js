  ...
  const productHTML = `
        ...
        <div class="row">
            <div class="col-md-6">
                <img src="${
                  movieFiltered.image
                }" class="img-fluid mb-4 rounded-start" alt="${
    movieFiltered.title
            ...
            <div class="col-md-6">
                ...
                <p class="text-light" style="font-size: 1.5rem; font-weight: bold; color: #ff5722;">Precio: $${
                  movieFiltered.price
                }</p>
                ...
                </p> <!-- Mensaje según el stock con clases de Bootstrap -->
